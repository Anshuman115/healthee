...
def get_sleep_insight(user: CurrentUser, refresh: bool = False) -> dict:
...
def get_activity_insight(user: CurrentUser, refresh: bool = False) -> dict:
...
def get_workout_insight(user: CurrentUser, start: str, refresh: bool = False) -> dict:
...
def get_notable(user: CurrentUser, refresh: bool = False) -> dict:
