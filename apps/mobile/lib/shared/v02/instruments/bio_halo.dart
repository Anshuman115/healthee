...
///
/// ## Three ways it stops, and each one really stops it
///
/// The prototype pauses offscreen, pauses when the tab is hidden, and disables
/// itself under the system's reduced-motion setting. All three are here, and all
/// three **stop the ticker** rather than setting a flag the painter consults:
///
